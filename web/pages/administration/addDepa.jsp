          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">添加部门</h3>
                <span style="color:red;font-weight: bold;font-size: 18px;">${error}</span>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="DepartmentServlet?method=add" method="post" >
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="deptName" placeholder="部门名称" name="deptName">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="location" class="col-sm-2 col-form-label">办公地点</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="location" placeholder="办公地点" name="location">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
